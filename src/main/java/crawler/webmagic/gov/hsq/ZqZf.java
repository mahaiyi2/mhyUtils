...
public class ZqZf implements PageProcessor {
	public static final String SITE_NAME="左旗政府";
	public static final String SITE_BASE_PATH="http://www.blzq.gov.cn";
    ...
    public void process(Page page) {
    	...
    	List<Selectable> slList = page.getHtml().xpath("//div[@class='PagedArticleList_Default_List']/ul/li").nodes();
    ...
    public static void spriderStart() {
    	Spider spider = Spider
    			.create(new ZqZf())
    			.addUrl("http://www.blzq.gov.cn/zfzx/bmdt/")
    			.addUrl("http://www.blzq.gov.cn/zfzx/smxzdt/")
    			.thread(1);
