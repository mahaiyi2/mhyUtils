...
public class KqZf implements PageProcessor {
	public static final String SITE_NAME="克旗政府";
	public static final String SITE_BASE_PATH="http://www.kskt.gov.cn";
    ...
    public static void spriderStart() {
    	Spider spider = Spider
    			.create(new KqZf())
    			.addUrl("http://www.kskt.gov.cn/xwzx/jrkq/")//克旗要闻
    			.thread(1);
