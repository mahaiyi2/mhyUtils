...
public class WqZf implements PageProcessor {
	public static final String SITE_NAME="翁旗政府";
	public static final String SITE_BASE_PATH="http://www.wnt.gov.cn";
    ...
    public void process(Page page) {
    	...
    	List<Selectable> slList = page.getHtml().xpath("//div[@class='PagedArticleList_Default']/ul/li").nodes();
    ...
    public static void spriderStart() {
    	Spider spider = Spider
    			.create(new WqZf())
    			.addUrl("http://www.wnt.gov.cn/xwzx/jrwq/")//今日翁旗
    			.addUrl("http://www.wnt.gov.cn/xwzx/jcdt/")//基层动态
    			.thread(1);
