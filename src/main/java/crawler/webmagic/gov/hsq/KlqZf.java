...
public class KlqZf implements PageProcessor {
	public static final String SITE_NAME="喀喇沁旗政府";
	public static final String SITE_BASE_PATH="http://www.klq.gov.cn";
    ...
    public void process(Page page) {
    	...
    	List<Selectable> slList = page.getHtml().xpath("//div[@class='zy_nr']/ul/li").nodes();
    ...
    public static void spriderStart() {
    	Spider spider = Spider
    			.create(new KlqZf())
    			.addUrl("http://www.klq.gov.cn/channels/287.html")//旗级要闻
    			.addUrl("http://www.klq.gov.cn/channels/368.html")//基层动态
    			.thread(1);
